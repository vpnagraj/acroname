...
#'
#' @param collapsed The collapsed string of characters generated by \link[acroname]{process_input}
...
#' @export
#'
process_input <- function(input, ignore_articles = TRUE, bow = FALSE, bow_prop = 0.5) {
