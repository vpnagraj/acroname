...
Each function can also be customized exclude articles in the input string:
...
To generate a series of randomized results, consider iterating over the function:
